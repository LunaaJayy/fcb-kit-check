...
Vandaag hebben we de eerste helft van de dag geluisterd naar de introductie en een kleine workshop over Astro. Daarna heb ik bedacht wat ik wil gaan doen: welke content api's ik wil gebruiken, welke web api ik ga gebruiken, en wat mijn concept precies is:
Een webpagina waarbij je de aankomende wedstrijden van FC Barcelona kan zien, het weer wt het dan wordt en welke 'kit' (team tenue, merchandise van het team) je dan het beste aan kan doen. Voor de kit heb ik geen API, die foto's moet ik zelf vinden. De detailpagina zal een overzicht worden van de statistieken tussen de twee teams.

De webapi die ik zal gebruiken is de geolocation API, voor als de gebruiker de wedstrijd thuis wilt kijken.

**Hoeveel tijd heeft me dat gekost?**\
Het bedenken en alles heeft me de halve dag gekost, ongeveer 3 uur.

**Wat heb ik geleerd?**\
Ik heb geleerd over het verschil tussen Content en Web API's en ook over query parameters binnen een url. Ook heb ik geleerd wat Astro is en wat je ermee kan.

**Wat ga ik morgen doen?**\
De volgende keer ga ik mijn concept verder uitwerken. 

## Reflectie Week 1
Ik had naar mijn idee eem hele goede manier om ideeën op te doen / te conceptualiseren wat ik nou eigenlijk wilde, wat goed bij een leerdoel van mij past. Het was iets lastiger om te bedenken welke content API ik nou eigenlijk wilde gebruiken, maar toen ik eenmaal wat ideeën had kon ik goed bedenken hoe ik wilde dat het eruit ging zien. Het helpt mij erg om mijn gedachtes op te schrijven om zo op een idee te komen. Zo kwam ik op mijn hoofdidee om een API te maken over FC Barcelona, en welke kleding je aan moet doen voor elke wedstrijd.

<img src="/readme-media/dag1-fcb-idee.jpeg" alt="" width="500px">

Als dit idee niet voldoende was had ik ook nog een ander idee bedacht met de Rijksmuseum API. Dit is ook te zien in mijn boekje.

<img src="/readme-media/dag1-rijks-idee.jpeg" alt="" width="500px">

Verder ging ik ook opschrijven wat ik nodig had. Ook ging ik verder conceptualiseren hoe ik wilde dat mijn idee eruit zoou zien. Dit heb ik heel vaag geschetst in mijn boekje. Ik twijfel nog over ik de informatie links wil laten zien, of gewoon in het midden van de pagina.

<img src="/readme-media/dag1-fcb-schets.jpeg" alt="" width="500px">

<img src="/readme-media/dag1-fcb-schets2.jpeg" alt="" width="500px">

Na het voortgangsgesprek ben ik erg geïnspireeerd geraakt en heb ik zin om verder te gaan. Het is interessant dat het zo'n nieuwe manier weer van coderen is.
...
**Wat heb ik vandaag gedaan?** \
Vandaag heb ik eerst de localStorage workshop bijgewoond. Vervolgens heb ik de API verder geïmplementeerd zodat ik alle informatie over FC Barcelona te zien krijg. Verder ben ik begonnen met het geven van stijling.

**Hoeveel tijd heeft me dat gekost?**\
De API workshop heeft een ochtend geduurd. De rest duurde de rest van de dag, zo'n 3/4 uur.

**Wat heb ik geleerd?**\
Ik heb over localStorage geleed, Temporal API en meer over Astro.

**Wat ga ik morgen doen?**\
Morgen ga ik de weather API toevoegen en starten met de detail pagina

## Reflectie Week 2
Het duurde erg lang voordat ik begreep hoe Astro nou echt werkte, gelukkig heeft het nu wel geklikt in mijn hoofd. Ik denk ook dat ik het steeds beter ga begrijpen hoe meer ik er mee bezig ben. Ik vind het nog een beetje vaag wanneer ik nou waar de stijling moet toevoegen. Ook wanneer ik van iets een component moet maken en wanneer iets gewoon een layout is. Ik heb bijvoorbeeld niet echt terugkerende componenten (denk ik tot nu toe).

Gelukkig heb ik nog wel erg veel zin om verder te gaan aan de API. Het begin van de uitleg over Astro had mij een beetje ontmoedigd, maar ik ben weer erg geïnspireerd geraakt naarmate ik verder bezig ging met mijn website. Uit het voortgangsgepsrek kwamen ook weer hulp over hoe ik bijvoorbeeld de Geolocation API het beste kon gebruiken, en welke code daarvoor. 

Deze week heb ik niets in mijn boekje getekend/geschreven. Ik ging vooral bezig met het coderen dus was het ook niet nodig. Wel heb ik erg zitten spelen (om het even positief te benaderen) met hoe ik nou mijn stijling wil doen, en ik twijfel nog steeds. Ik weet niet of ik alle informatie nou in het midden wil laten zien, of juist aan de linkerkant..

<img src="/readme-media/week2-info-links.png" alt="" width="500px">

<img src="/readme-media/week2-info-midden.png" alt="" width="500px">

Ik denk dat ik er pas achter ga komen als alle informatie die ik wil laten zien in de index pagina staat.

## Week 3
### Dag 4 - Woensdag 15 april

Ik was er niet ivm Smashing Conference!
